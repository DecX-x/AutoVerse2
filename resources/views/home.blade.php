    ...
    <section class="footer">
        <div class="footer-row">
            <div class="footer-col">
                <h4>AutoVerse</h4>
                <ul class="links">
                    <li><a href="#">About Autoverse</a></li>
                    <li><a href="#">Copyright</a></li>
                    <li><a href="#">Blog</a></li>
                    <li><a href="#">Daily promo</a></li>
            ...
            <div class="footer-col">
                <h4>Newsletter</h4>
                <p>
                    Subscribe to <span>Autoverse</span> for a weekly dose
                    of news, updates, helpful tips, and
                    exclusive offers.
                </p>
                <form action="#">
                    <input type="text" placeholder="Your email" required>
                    <button class="border" type="submit">SUBSCRIBE</button>
                </form>
